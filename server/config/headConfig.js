  ...
  SeoCollection.update(
    ...
    },
    {
      $set: {
        ...
        meta: {
          'description': 'Look at all these amazing features Project Title has.'
        }
      }
    },
    {
  ...
  SeoCollection.update(
    ...
    },
    {
      $set: {
        ...
        meta: {
          'description': 'Read about how Project Title came to be.'
        }
      }
    },
    {
  ...
  SeoCollection.update(
    ...
    },
    {
      $set: {
        ...
        meta: {
          'description': 'This is your Project Title profile page.'
        }
      }
    },
    {
  ...
  SeoCollection.update(
    ...
    },
    {
      $set: {
        ...
        meta: {
          'description': 'This is the Project Title logout page.'
        }
      }
    },
    {
